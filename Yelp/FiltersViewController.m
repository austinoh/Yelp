...
@property (nonatomic, retain) NSDictionary *filterDictionaries;
@property (nonatomic, strong) NSMutableSet *selectedFilters;

- (void)initCategories;
- (void)initFilterDictionaries;
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView {
    NSLog(@"# of Sections in tableview = %lu", (unsigned long)[self.filterDictionaries count]);
    
    return [self.filterDictionaries count];
}

- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
    return [[self.filterDictionaries allKeys] objectAtIndex:section];
}

- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    NSString *sectionTitle = [self tableView:self.tableView titleForHeaderInSection:section];
    return [[self.filterDictionaries valueForKey:sectionTitle] count];
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    SwitchCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SwitchCell"];
    NSString *groupTitle = [self tableView:self.tableView titleForHeaderInSection:indexPath.section];
    
    NSDictionary *values = [[self.filterDictionaries valueForKey:groupTitle] objectAtIndex:indexPath.row];
    
    cell.titleLabel.text = values[@"name"];
...
- (void)initFilterDictionaries {
    self.filterDictionaries =
    @{
      @"Distance": @[@{@"name": @"Best Match", @"code": @100},
                     @{@"name": @"0.3 miles", @"code": @300},
                     @{@"name": @"1 mile", @"code": @500},
                     @{@"name": @"5 miles", @"code": @1000},
                     @{@"name": @"20 miles", @"code": @10000}],
      @"Sort by": @[@{@"name": @"Best Match", @"code": @0},
